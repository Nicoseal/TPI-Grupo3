...
TEST(customTEST, mas20Habitantes) {
    eph_h th = {{31117, 2020,   3,  319611, 629088, 3,  41, 0,  1,  3,  1,  2}};
    eph_i ti = {{31117, 2020,   15,  1,  3,  1,  88, 0,  0,  90000,  10},
                {31117, 2020,   14,  1,  3,  2,  82, 0,  0,  25000,  10},
                {31117, 2020,   1,  0,  3,  1,  58, 1,  3,  22000,  1},
                {31117, 2020,   2,  0,  3,  2,  54, 1,  1,  -1,     1},
                {31117, 2020,   3,  0,  3,  2,  46, 1,  3,  17000,  1},
                {31117, 2020,   4,  0,  3,  1,  20, 1,  3,  5000,   1},
                ...
                {31117, 2020,   9,  0,  3,  1,  50, 0,  2,  0,      10},
                {31117, 2020,   10, 0,  3,  1,  28, 1,  3,  5000,   1},
                {31117, 2020,   11,  0,  3,  1,  31, 1,  3,  59000,  10},
                {31117, 2020,   12,  1,  3,  2,  28, 1,  3,  0,      6},
                {31117, 2020,   13,  0,  3,  1,  18, 0,  0,  20000,  10},
                {31117, 2020,   16,  0,  3,  1,  25, 0,  0,  150,  10},
                {31117, 2020,   17,  0,  3,  1,  12, 0,  0,  200,  10},
                {31117, 2020,   18,  0,  3,  1,  11, 0,  0,  150,  10},
                {31117, 2020,   19,  0,  3,  1,  8, 0,  0,  700,  10},
                {31117, 2020,   20,  0,  3,  1,  2, 0,  0,  500,  10},
                {31117, 2020,   21,  0,  3,  1,  19, 0,  0,  450,  10},
                {31117, 2020,   7,  0,  3,  1,  7, 0,  0,  7,  10}};

    EXPECT_FALSE(esEncuestaValida(th, ti));
}

TEST(customTEST, hogarSinIndividuo) {
...
TEST(customTEST, II2MayorIV2) {

    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  41, 0,  1,  1,  3,  2},
                {31117, 2020,   3,  332870, 642475, 3,  40, 0,  1,  6,  6,  2},
                {22866, 2020,   3,  317157, 627217, 2,  42, 1,  1,  1,  2,  2},
                {20957, 2020,   3,  313965, 623297, 1,  43, 0,  1,  3,  1,  2}};
...
TEST(customTEST, columnasIndIncorrectas) {
    eph_h th = {{22114, -2020,   3,  319611, 629088, 3,  41, 0,  1,  3,  1,  2}};
    eph_i ti = {{22114, -2020,   1,  0,  3,  1,  18, 0,  0,  20000}};
    EXPECT_FALSE(esEncuestaValida(th, ti));
}

TEST(customTEST, atribsTHErroneos) {
    eph_h th = {{22114, -2020,   3,  319611, 629088, 3,  8, 0,  1,  3,  1,  2}};
    eph_i ti = {{22114, -2020,   1,  0,  3,  1,  18, 0,  0,  20000, 10}};
    EXPECT_FALSE(esEncuestaValida(th, ti));
}

TEST(customTEST, edadesEnRango) {
    ...
    eph_i ti = {{20957, 2020,   1,  1,  3,  1,  88, 0,  0,  90000,  10},
                ...
                {31117, 2020,   2,  0,  3,  2,  54, 1,  1,  -1,     1},
                {31117, 2020,   3,  0,  3,  2,  46, 1,  3,  17000,  1},
                {31117, 2020,   4,  0,  3,  1,  1, 1,  3,  5000,   1},
                {31117, 2020,   5,  0,  3,  2,  15, 0,  0,  5000,   10},
                {31117, 2020,   6,  0,  3,  1,  7,  0,  0,  0,      10},
                {31117, 2020,   8,  0,  3,  2,  11, 0,  0,  0,      10},
                {31117, 2020,   9,  0,  3,  1,  0, 0,  2,  0,      10},
                {31117, 2020,   10, 0,  3,  1,  28, 1,  3,  5000,   1},
                {22866, 2020,   1,  0,  3,  1,  31, 1,  3,  59000,  10},
                {22866, 2020,   2,  1,  3,  2,  190, 1,  3,  0,      6},
                {22114, 2020,   1,  0,  3,  1,  18, 0,  0,  20000,  10}};
